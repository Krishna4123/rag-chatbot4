...
class TelegramRAGBot:
    ...
    async def help_command(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        help_message = (
            ...
            "- Upload a PDF file: I will ingest the document and use it to answer future questions related to its content. "
            "Your Telegram ID will be used as the namespace for your documents."
        )
    ...
    async def handle_text_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        try:
            response = requests.post(
                ...
                json={'query': user_query, 'namespace': str(user_id)},
                timeout=30
            )
